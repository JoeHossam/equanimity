...
const MOCKDATA = [
    { title: 'Email', description: 'support@equanimity.com', icon: At },
    { title: 'Phone', description: '+201000000000', icon: Phone },
    { title: 'Address', description: '97 Sheikh Zayed', icon: MapPin },
